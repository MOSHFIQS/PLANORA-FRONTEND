               ...
               <div>
                    ...
                    <div className="flex items-center justify-between lg:hidden px-4">
                         ...
                         <Sheet>
                              ...
                              <SheetContent side="right" className="w-[300px] px-3 bg-white">
                                   <SheetHeader>
                                        <SheetTitle className="text-center text-xl font-bold text-gray-900">PLANORA</SheetTitle>
                                   </SheetHeader>
                                   ...
                                   <div className="flex flex-col gap-4 mt-6">
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                             {menu.map((item) => (
                                                  <Link
                                                       ...
                                                       onClick={(e) => handleNavClick(e, item.url)}
                                                  >
                                                       <button className={`w-full text-left px-4 py-2 rounded-full text-sm font-medium transition-all ${isActive(item.url)
                                                            ? "bg-[#FE7743] text-white"
                                        ...
                                        <div className="flex flex-col gap-2">
                                             {user?.id ? (
                                                  <>
                                                       <Link href={`${basePath}/my/profile`}>
                                                            <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm border border-gray-100 bg-white hover:bg-gray-50 transition-colors group">
                                                                 ...
                                                                 <span className="font-medium text-gray-700">My Profiles</span>
                                                            </button>
                                                       </Link>
                                                       <Link href={`${basePath}`}>
                                                       ...
                                                       <Link href={`${basePath}/my/participated-events`}>
                                                            <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm border border-gray-100 bg-white hover:bg-blue-50 transition-colors">
                                                                 ...
                                                                 <span className="font-medium text-gray-700">My Participated Events</span>
                                                            </button>
                                                       </Link>
                                                  ...
                                                  <>
                                                       <Button asChild variant="outline" className="w-full rounded-full border-gray-300 bg-white">
                                                            <Link href={`/login?redirect=${pathname}`}>Login</Link>
                                                       </Button>
                                                       <Button asChild className="w-full rounded-full bg-[#FE7743] hover:bg-orange-500 text-white border-0">
                                                            <Link href="/register">Register</Link>
                                                       </Button>
                                                  </>
                                             )}
